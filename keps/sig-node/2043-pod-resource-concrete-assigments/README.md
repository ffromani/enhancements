...
- `GetAllocatableResources`, which return a single AllocatableResourcesResponse, enabling applications to know about the node capacity in terms of computing resources.
...
- 2021-02-02: KEP updated removing the Watch API, postponed to a later KEP.
